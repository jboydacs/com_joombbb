...
class BBBModelmeetings extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		$query->select('a.*');
		$query->from('#__bigbluebutton_meetings as a');
		...
		if (!empty($search))
		{
			...
			else
			{
				...
				$query->where('(a.meetingName LIKE ' . $search . '  OR a.moderatorPW LIKE ' . $search . '  OR a.attendeePW LIKE ' . $search . '  OR a.start_time LIKE ' . $search . ' )');
			}
		}
