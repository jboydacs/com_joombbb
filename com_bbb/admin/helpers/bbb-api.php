...
with BBB; if not, see <http://www.gnu.org/licenses/>.
	...
	*/
	...
	public function getCreateMeetingUrl($creationParams) {
		...
		*/
		...
		'&startTime='.urlencode($creationParams['startTime']).
		'&endTime='.urlencode($creationParams['endTime']).
	...
	public function createMeetingWithXmlResponseArray($creationParams, $xml = '') {
		...
		$creationParams = array(
			...
			'duration' => '120', 			-- Default = 120 set duration in minutes. [number]
