...
class BBBViewtypes  extends JViewLegacy {
	...
	protected function addToolbar()
	{
		...
		{
			JToolbarHelper::deleteList('', 'types.delete', 'Delete');
		}
				
		
		JToolBarHelper::preferences('com_bbb', '550');  
		if(!version_compare(JVERSION,'3','<')){		
			JHtmlSidebar::setAction('index.php?option=com_bbb&view=types');
		}
