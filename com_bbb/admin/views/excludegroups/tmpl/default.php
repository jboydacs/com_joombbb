...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_bbb&task=excludegroups.saveOrderAjax&tmpl=component';
			...
			<tr>
				...
				<th class="title">
					<?php echo JHTML::_('grid.sort', 'Id', 'a.id', $listDirn, $listOrder ); ?>
								...
								<th class="title">
					<?php echo JHTML::_('grid.sort', 'Group Title', 'a.group_name', $listDirn, $listOrder ); ?>
				</th>
				<th class="title">
					<?php echo "Group ID" ?>
				</th>
  ...
  if (count($this->items)) : 
  		foreach ($this->items as $i => $item) :
    			...
    			if (JFactory::getApplication()->input->get('function', null)) {
    				$onclick= "onclick=\"window.parent.jSelectExcludeGroup_id('".$item->id."', '".$this->escape($item->group_name)."', '','id')\" ";
    			}  	
    
 				$link = JRoute::_( 'index.php?option=com_bbb&view=excludegroup&layout=edit&id='. $item->id );
					...
					<div class="pull-left">
						...
						<div class="pull-left">
							<?php
								...
								JHtml::_('dropdown.edit', $item->id, 'excludegroup.');
...
<input type="hidden" name="task" value="excludegroup" />
<input type="hidden" name="view" value="excludegroups" />
