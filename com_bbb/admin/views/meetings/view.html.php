...
class BBBViewmeetings  extends JViewLegacy {
	...
	protected function addToolbar()
	{
		...
		{
			JToolbarHelper::deleteList('', 'meetings.delete', 'Delete');
		}
				
		
		JToolBarHelper::preferences('com_bbb', '550');  
		if(!version_compare(JVERSION,'3','<')){		
			JHtmlSidebar::setAction('index.php?option=com_bbb&view=meetings');
		}
