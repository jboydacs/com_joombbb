...
?>
<form action="<?php echo JRoute::_('index.php?option=com_bbb&view=meetings&layout=modal&tmpl=component&function='.$function);?>" method="post" name="adminForm" id="adminForm" class="form-inline">
			...
			<tr>				
				...
				<!--				<th class="title">
					...
					<?php // echo JHTML::_('grid.sort', 'AttendeePW', 'a.attendeePW', $listDirn, $listOrder ); ?>
								...
								<th class="title">
					<?php echo JHTML::_('grid.sort', 'start_time', 'a.start_time', $listDirn, $listOrder ); ?>
				</th>
								<th class="title">
