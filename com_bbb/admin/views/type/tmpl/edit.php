...
if (!$edit) {
	...
	JToolBarHelper::cancel( 'type.cancel', 'Close' );
}
?>
		...
		margin-right: 10px;
	 	...
	 	<div class="col <?php if(version_compare(JVERSION,'3.0','lt')):  ?>width-60  <?php endif; ?>span8 form-horizontal fltlft">
		  <fieldset class="adminform">
			<legend><?php echo JText::_( 'Add a Type' ); ?></legend>
				<div class="control-group">
					<div class="control-label">					
						<span class="hasTooltip" title="Add the type"><?php echo 'Add the type'; ?></span>
						<span class="star">&nbsp;*</span>
					</div>
					<div class="controls">	
						<input aria-invalid="false" required="" aria-required="true" name="title" id="title" class="type" value="<?php echo $this->item->title ?>" />
					</div>
				</div>
